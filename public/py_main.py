...
def main():
    ...
    js.updateLoadingStatus("Configuring design parameters...", 70)
    
    # 기본 입력값 확인 (초기 로드 체감용)
    get_default_design_inputs()
    
    js.updateLoadingStatus("Loading structural libraries...", 85)
    
    js.updateLoadingStatus("Finalizing UI components...", 95)
    js.console.log('BESTO Design Plugin initialized')
    
    # 모든 준비가 완료되면 로딩 화면 숨김
